...
class Screen(tk.Tk):
  def __init__(self):
    ...
    self.renovacoes = tk.Label(container, text="Proximas renovacoes", font=("Arial", 11), bg="black", fg="white")
    self.dominio1 = tk.Label(container, text="dominio1.com.br \n 27/05/04 \n dias para o vencimento: 10", font=("Arial", 11), bg="#1ea5ac", fg="white")

    self.controls.grid(row=0, column=1)
    
    self.clientes.grid(row=1, column=0)
    self.renovacoes.grid(row=2, column=0)
    self.dominio1.grid(row=3, column=0)
